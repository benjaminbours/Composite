...
import { UpsertRatingDtoTypeEnum } from '@benjaminbours/composite-api-client';
...
export const EndLevelScene: React.FC<Props> = React.memo(
    ({ dictionary, isMount }) => {
        const {
            state,
            lobbyMode,
        ...
        const getRatings = useCallback(() => {
            ...
            apiClient.defaultApi
                .levelsControllerGetRatings({
                    id: String(state.loadedLevel.id),
                })
                .then((ratings) => {
                    setRatings((prev) => {
        ...
        }, [enqueueSnackbar, state.loadedLevel, dictionary.common]);
        ...
        return (
            <div ref={refHashMap.endLevelRef} className={cssClass}>
                <AuthModal
                ...
                <div className="main-container">
                        ...
                        <div className="end-level-scene__run-info-container">
                            ...
                            <p>
                                <span>
                                    Level:{` `}
                                    <b>
                                        {state.loadedLevel?.name ||
                                            'Level name'}
                                    </b>
                                    <br /> made by:{' '}
                                    <b>
                                        {state.loadedLevel?.author?.name ||
                                            'Author name'}
                                    </b>
                                    <br />
                                    You did it in:{' '}
                    ...
                    <section className="end-level-scene__socials-section">
                        <div className="end-level-scene__text-container">
                            <p>
                                <span>
                                    If you liked the experience and you want it
                                    to reach its{' '}
                                </span>
                                <a
                                ...
                                <br />
                                <span>
                                    the best thing you can do is to talk about
                                    it.
                                </span>
                            </p>
                        ...
                        <div className="end-level-scene__socials-container">
                            <a
                                ...
                                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(
                                    `I just finished the level ${state.loadedLevel?.name} playing ${
