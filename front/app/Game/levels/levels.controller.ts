...
// our libs
import { Levels, TheHighSpheresLevel } from '@benjaminbours/composite-core';
// local
...
export default class LevelController {
    public levels: {
        ...
        [Levels.THE_HIGH_SPHERES]: TheHighSpheresLevel;
    };
    ...
    constructor(public currentLevel: Levels) {
        ...
        this.levels = {
            ...
            [Levels.THE_HIGH_SPHERES]: new TheHighSpheresLevel(),
        };
    }
