...
export function UpdateLevelDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateLevelDto {
    ...
    return {
        ...
        'lightStartPosition': !exists(json, 'lightStartPosition') ? undefined : json['lightStartPosition'],
        'shadowStartPosition': !exists(json, 'shadowStartPosition') ? undefined : json['shadowStartPosition'],
