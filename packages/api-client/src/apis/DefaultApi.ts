...
export class DefaultApi extends runtime.BaseAPI {
    ...
    /**
     */
    async appControllerGetServerInfoRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<PlayerStateResponse>>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(PlayerStateResponseFromJSON));
    }

    /**
     */
    async appControllerGetServerInfo(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<PlayerStateResponse>> {
